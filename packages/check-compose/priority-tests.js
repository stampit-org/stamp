...
module.exports = (compose) => {
  ...
  test('compose override priorities', (nest) => {
    nest.test('...with instance', (assert) => {
      ...
      assert.equal(actual, expected, 'properties should override instance props');
    ...
    nest.test('...with deepProperties', (assert) => {
      ...
      assert.equal(actual, expected, 'shallow properties should override deep properties');
    ...
    nest.test('...with descriptors', (assert) => {
      ...
      assert.equal(actual, expected, 'descriptors should override shallow properties');
      assert.end();
    });
    ...
    nest.test('...with instance & deepProperties', (assert) => {
      ...
      assert.equal(actual, expected, 'deepProperties should override instance props');
    ...
    nest.test('...with staticProperties', (assert) => {
      ...
      assert.equal(actual, expected, 'staticProperties should override staticDeepProperties');
      assert.end();
    });
  });
};
