    ...
    mergeProps.forEach(prop => {
      ...
      nest.test("array replaces object", t => {
        ...
        t.notEqual(
          actual,
          b.foo,
          "array replacing object should be deep merged: c.foo !== b.foo"
        );
      ...
      nest.test("object replaces array", t => {
        ...
        t.notEqual(
          actual,
          b.foo,
          "object replacing array should be deep merged: c.foo !== b.foo"
        );
      ...
      nest.test("array concat", t => {
        ...
        t.notEqual(
          actual,
          b.foo,
          "array should be deep merged from right: c.foo === b.foo"
        );
