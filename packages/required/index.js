...
const required = function required(settings) {
    const localStamp = (this && 'compose' in this) ? this : Required;
    ...
    const newSettings = (0, core_1.assign)({}, (0, compose_1.default)(prevSettings, settings).compose);
...
const checkDescriptorHaveThese = (descriptor, settings) => {
    if (descriptor && settings) {
        ...
        for (const settingsKey of settingsKeys) {
            ...
            if ((0, is_1.isObject)(settingsValue)) {
 ...
 * TODO
 */
const Required = (0, compose_1.default)({
    initializers: [
        (_, opts) => {
